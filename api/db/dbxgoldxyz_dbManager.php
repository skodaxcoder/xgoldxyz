...
function getConnection() {
	...
	global $db_xgoldxyz_db_Url, $db_xgoldxyz_db_User, $db_xgoldxyz_db_Pass, $db_xgoldxyz_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_xgoldxyz_db_Url.";dbname=".$db_xgoldxyz_db_DbName, $db_xgoldxyz_db_User, $db_xgoldxyz_db_Pass);
